...
## Migration from .github/skills/

The original `8-acs-deprecation-scan` skill was in `.github/skills/` (incorrect location). It has been copied to `.claude/skills/` (correct location).

**Action Required:**
You can safely delete the old `.github/skills/` directory:
```bash
rm -rf .github/skills
```
...
4. **Share skills:** Move to `~/.claude/skills/` to use across all projects
